...
COMMANDS: dict[str, list[BotCommand]] = {
    "en": [
        ...
        BotCommand(command="history", description="Recent batches"),
    ...
    "ru": [
        ...
        BotCommand(command="history", description="Прошлые пачки"),
    ...
    "uk": [
        ...
        BotCommand(command="history", description="Минулі пачки"),
